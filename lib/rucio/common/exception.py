...
class ClientProtocolNotSupported(RucioException):
    ...
    def __init__(self, host: str, protocol: str, protocols_allowed: Optional[list[str]] = None, *args: str) -> None:
...
class MetalinkJsonParsingError(RucioException):
    ...
    """
    def __init__(self, data: "FileDescriptorOrPath", metalink_err: "ParseError", json_err: ValueError, *args: str) -> None:
...
class PolicyPackageBaseException(RucioException):
    ...
    """
    def __init__(self, package: str, *args: str) -> None:
...
class InvalidAlgorithmName(RucioException):
    ...
    """
    def __init__(self, algorithm: str, vo: str, *args: str) -> None:
...
class PolicyPackageVersionError(PolicyPackageBaseException):
    ...
    """
    def __init__(self, package: str, rucio_version: str, supported_versionset: str, *args: str) -> None:
...
class ClientProtocolNotFound(RucioException):
    ...
    def __init__(self, host: str, protocols_allowed: Optional[list[str]] = None, *args: str) -> None:
...
class ConnectionParameterNotFound(RucioException):
    ...
    """
    def __init__(self, param: str, *args: str) -> None:
